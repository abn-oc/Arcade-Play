...
export default function Home() {
    ...
    const [games, setGames] = useState<{ID: number, gameName: string, icon: number}[]>([]);
    ...
    useEffect(() => {
        (async () => {
            ...
            setGames(games.map(game => ({ID: game.GameID, gameName: game.GameName, icon: game.Icon})))
        })()
    }, []);
        ...
        <div className="p-4 flex flex-row gap-4">
            ...
            <div className="flex flex-row gap-4 flex-wrap justify-center">
                ...
                >
                    ...
                    />
                    <p className="mt-2 text-sm font-medium text-gray-700">{game.gameName}</p>
                </div>
                )}
            </div>
